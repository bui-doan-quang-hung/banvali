...
public partial class QuanlibanvaliContext : DbContext
{
    public QuanlibanvaliContext()
    {
    }

    public QuanlibanvaliContext(DbContextOptions<QuanlibanvaliContext> options)
        : base(options)
    {
    }
    ...
    => optionsBuilder.UseSqlServer("Data Source=LAPTOP-SRCDJ92D\\SQLEXPRESS;Initial Catalog=quanlibanvali;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");
